...
class PeripheralsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create peripheral" do
    assert_difference("Peripheral.count") do
      post peripherals_url, params: { peripheral: { description: @peripheral.description, name: @peripheral.name, price: @peripheral.price } }, as: :json
    end
  ...
  test "should update peripheral" do
    patch peripheral_url(@peripheral), params: { peripheral: { description: @peripheral.description, name: @peripheral.name, price: @peripheral.price } }, as: :json
    assert_response :success
  end
